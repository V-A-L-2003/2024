...
#gen controler
genoma = [0, 0, 0]  # Inicializando com três elementos
def step():
    if genoma[0] !=0:
        pass
    elif genoma[0] ==0:
...
def geradordegenoma():
    if genoma[2]==0:
        print(f"seu genoma é{genoma[2]},{metodologia_string[0]}")
    if genoma[2]==1:
        print(f"seu genoma é{genoma[2]},{metodologia_string[1]}")
    if genoma[2]==2: 
        print(f"seu genoma é{genoma[2]},{metodologia_string[2]}")
def secontstep():
    genoma[1]=0
    if genoma[1]==0:
